  ...
  return (
    <div className="flex flex-col gap-6 w-full h-full p-6">
      <div className="bg-white/60 backdrop-blur-md border border-white/40 p-6 rounded-3xl shadow-sm">
        <h1 className="text-xl font-bold tracking-tight text-slate-800">Reminders</h1>
        <p className="text-xs text-slate-500 mt-1">Manage your recurring bills and financial reminders.</p>
      </div>
